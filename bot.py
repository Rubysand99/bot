...
def _strip_unicode_font(text: str) -> str:
    ...
    ranges = [
        ...
        (0x1D4D0, 0x1D4E9, ord('A')),   # Script A-Z
        (0x1D4EA, 0x1D503, ord('a')),   # Script a-z
...
class SetupFontSampleModal(Modal, title="✏️ Đổi Tên Kênh Hàng Loạt"):
    ...
    font_name = TextInput(
        label="Tên font: normal/bold/sans_bold/serif/script/double",
        placeholder="bold  (= 𝐐𝐮𝐢𝐞𝐭 𝐒𝐜𝐡𝐞𝐦𝐚𝐭𝐢𝐜𝐬)  |  serif = Math Bold Serif",
        default="bold",
        max_length=20,
        required=False
    )
