...
DEFAULT_DATA = {
    ...
    # ── Cấu hình role buyer tự động theo tổng tiền ──
    # buy_roles: list các dict {"min_amount": int, "max_amount": int|None, "role_id": int, "label": str}
    # Ví dụ: [{"min_amount": 50000, "max_amount": 100000, "role_id": 123, "label": "buyer 50-100k"}]
    "buy_roles": [],
    # Lưu tổng tiền đã mua của từng user: {"user_id_str": int (VNĐ)}
    "user_total_spent": {},
}
