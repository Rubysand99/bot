...
class CreateChannelModal(Modal, title="➕ Tạo Kênh Mới"):
    ...
    font    = TextInput(label="Font (normal/bold/sans_bold/script/double)", placeholder="normal", default="normal", max_length=20, required=False)
...
class SetupFontSampleModal(Modal, title="✏️ Đổi Tên Kênh Hàng Loạt"):
    ...
    font_name = TextInput(
        label="Tên font: normal/bold/sans_bold/script/double",
        placeholder="bold  (= 𝐐𝐮𝐢𝐞𝐭 𝐒𝐜𝐡𝐞𝐦𝐚𝐭𝐢𝐜𝐬)",
        default="bold",
        max_length=20,
        required=False
    )
