...
# 2. Ghi requirements.txt
echo "📝 Ghi requirements.txt..."
...
# 3. Ghi cogs/admin.py
echo "📝 Ghi cogs/admin.py..."
cat > cogs/admin.py << 'ADMINEOF'
"""
...
# 4. Commit & push
echo "🚀 Commit & push..."
git add requirements.txt cogs/admin.py
git commit -m "chore: remove matplotlib, fix stale banking help text"
