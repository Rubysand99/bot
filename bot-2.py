...
MOD_FIXLAG_LIST = [
    "Sodium — Tối ưu render, tăng FPS mạnh",
    "Lithium — Tối ưu game logic & physics",
    "FerriteCore — Giảm RAM usage",
    "EntityCulling — Ẩn entity ngoài tầm nhìn",
    "ImmediatelyFast — Tối ưu render entity/UI",
    "Starlight — Tối ưu engine ánh sáng",
    "ModernFix — Giảm load time & memory",
]
